                  ...
                  <table style="margin: 0 auto;" cellspacing="0" cellpadding="8" width="100%">
                    <tr>
                      <td style="border: 1px solid #a1a1a1; text-align:center;">
                        <p><?php echo $mensaje; ?> <?php echo $nombres; ?></p>
                      </td>
                    </tr>
                  </table>
                  </center>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        ...
                        Ha realizado una nueva venta desde el sistema de naturandes, estas se encuenta con status no pagada hasta que el admin las verifiques.
                        <br><br>
