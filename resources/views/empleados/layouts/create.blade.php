<div class="collapse multi-collapse" id="RegistrarEmpleado" style="position: absolute; margin-left: -8px; width: 100% !important; background-color: white !important;">
	<div class="card-header">
      <a data-toggle="collapse" data-target="#RegistrarEmpleado" aria-expanded="false" aria-controls="RegistrarEmpleado" class="btn btn-primary btn-sm text-uppercase float-right text-white" style="border-radius: 5px; float: right;" onclick="cerrar(4)">
        	...
        	<div class="row">
        		<div class="col-md-4">
        			<div class="form-group">
			          ...
			          <input onkeypress="return check(event)" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" placeholder="Ingrese usuario" name="usuario" required id="usuario" value="{{ old('usuario') }}">
